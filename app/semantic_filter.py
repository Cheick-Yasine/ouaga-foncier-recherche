...
def _instructions() -> str:
    return (
        ...
        "offrant une surface nettement plus grande doit passer devant une petite surface. "
        "À superficie proche, favorise le prix le plus proche du budget sans le dépasser, "
        "puis la qualité du document et la complétude des informations. "
